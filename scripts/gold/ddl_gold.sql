...
The gold layer represents the fnal dimension and fact tables (star schema).
...
SELECT
  ROW_NUMBER() OVER(ORDER BY pn.prd_start_date, pn.prd_key) AS product_key,	pn.prd_id AS product_id,
